...
//MODULE_PAYMENT_BRAINTREE_CURRENCY
    ...
    function admin_notification($zf_order_id) {
        ...
        if ($braintree_order_details->RecordCount() == 0)
            $braintree_order_details->fields = array();
    ...
    function install() {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Version', 'MODULE_PAYMENT_BRAINTREE_VERSION', '1.2.1', 'Version installed (do not change this value unless you would like the automatic upgrade to run)', '6', '2', now())");
